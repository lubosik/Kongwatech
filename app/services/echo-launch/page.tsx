...
export const metadata: Metadata = {
  title: 'Echo Launch | In-Person AI Ecosystem Launch',
  description:
    'Echo Launch is Kongwa Tech\'s in-person AI ecosystem launch engagement. Lubosi Kongwa comes into your environment and helps launch your first working AI systems.',
}
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Where does Echo Launch take place?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Echo Launch takes place in person inside your business environment. Travel is included for locations within Southeast England. Other locations can be discussed during the application call.',
      },
    },
    {
      '@type': 'Question',
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'No. Echo Launch is a hands-on implementation engagement. It includes strategic thinking, but the goal is to launch a working AI environment rather than simply discuss AI ideas.',
      },
    },
  ],
}
...
export default function EchoLaunchPage() {
  return (
    <>
      <script
        ...
        <div className="max-w-5xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
            <div className="lg:col-span-2 space-y-6 font-sans text-charcoal/80 text-base leading-relaxed">
              <p>
                Echo Launch is for businesses that do not just want to talk about AI. Lubosi comes into
